        ...
        private void btnREGISTER_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (OleDbConnection connection = new OleDbConnection(connectionString))
                {
                    ...
                    // Use parentheses around column names in the SQL query
                    string query = "INSERT INTO adminacc ([FIRSTNAME], [MIDDLENAME], [LASTNAME], [EMAIL], [BIRTHDATE], [IMAGE], [USERNAME], [PASSWORD]) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
